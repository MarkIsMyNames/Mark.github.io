...
export const projects: Project[] = [
  {
    ...
    tags: ['Ember.js', 'JavaScript', 'TypeScript', 'Ruby', 'AI/ML', 'MCP Servers', 'GitHub Actions', 'Voice Recognition'],
    orderIndex: 0,
  },
  {
    id: '2',
    ...
    tags: ['TypeScript', 'Python', 'Image Processing', 'Web Development', 'Performance Optimisation', 'Team Leadership', 'Algorithm Design'],
    orderIndex: 1,
  },
  {
    id: '3',
    ...
    tags: ['Python', 'AI/ML', 'Robotics', 'Entrepreneurship', 'Climate Tech', 'Business Strategy', 'Sustainability'],
    orderIndex: 2,
  },
];
